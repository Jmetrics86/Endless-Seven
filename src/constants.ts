...
export const DARK_POOL: CardData[] = [
  ...
  { name: "The Destroyer", faction: "Darkness", type: "God", power: 15, isChampion: true, ability: "Flip: Corrupt un-championed non-Darkness Seals.", hasGlobalAbility: true, effect: 'corrupt_undefended' },
